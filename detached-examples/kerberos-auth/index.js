...
function startServer () {
    ...
    execSync('docker cp server/package.json server:home/server/package-lock.json');
...
function startClient () {
    ...
    execSync('docker cp client/package.json client:home/client/package-lock.json');
